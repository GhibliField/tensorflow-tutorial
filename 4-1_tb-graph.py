...
"""
这个脚本是在3-2的基础上增加tensorboard的可视化功能,在tensorboard中的graph标签页显示图结构
"""

import tensorflow as tf
import numpy as np

def addlayer(inputs,in_size,out_size,activation_func=None):
...
if __name__=='__main__':
    ...
    # add hidden layer
    l1=addlayer(xs,1,10,activation_func=tf.nn.relu)
    # add output layer
    prediction=addlayer(l1,10,1,activation_func=None)
